...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="{{ route('presupuestos.update', $presupuesto->id_presupuesto) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    name="nombre_cliente"
                    class="form-control"
                    value="{{ old('nombre_cliente', $presupuesto->nombre_cliente) }}"
                    required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    name="fecha"
                    class="form-control"
                    value="{{ old('fecha', $presupuesto->fecha) }}"
                    required>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input
                        ...
                        name="vigencia_dias"
                        class="form-control"
                        value="{{ old('vigencia_dias', $presupuesto->vigencia_dias) }}">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ old('anticipo_porcentaje', $presupuesto->anticipo_porcentaje) }}">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea
                    name="observaciones"
                    class="form-control"
                    rows="3">{{ old('observaciones', $presupuesto->observaciones) }}</textarea>
            </div>
            ...
            <div id="contenedor-materiales">
                ...
                @forelse($presupuesto->detalles as $i => $detalle)

                    <div class="card mb-3 fila-material" data-indice="{{ $i }}">
                        <div class="card-body">
                                    ...
                                    <select
                                        ...
                                        @foreach($materiales as $material)
                                            <option
                                                ...
                                                @selected($material->id_material == $detalle->id_material)>
                                                {{ $material->nombre }}
                                ...
                                <div class="col-md-5 mb-2">
                                    ...
                                    <div class="btn-group w-100" role="group">
                                        <input
                                            ...
                                            name="materiales[{{ $i }}][modo_calculo]"
                                            id="modo-manual-{{ $i }}"
                                            value="manual"
                                            @checked($detalle->modo_calculo !== 'rendimiento')>
                                        <label class="btn btn-outline-secondary btn-sm" for="modo-manual-{{ $i }}">
                                        ...
                                        <input
                                            ...
                                            class="btn-check radio-modo"
                                            name="materiales[{{ $i }}][modo_calculo]"
                                            id="modo-rendimiento-{{ $i }}"
                                            value="rendimiento"
                                            @checked($detalle->modo_calculo === 'rendimiento')>
                                        <label class="btn btn-outline-secondary btn-sm" for="modo-rendimiento-{{ $i }}">
                            ...
                            <div class="row bloque-manual {{ $detalle->modo_calculo === 'rendimiento' ? 'd-none' : '' }}">
                                <div class="col-md-4">
                                    ...
                                    <input
                                        ...
                                        value="{{ $detalle->modo_calculo === 'rendimiento' ? '' : $detalle->cantidad }}">
                                </div>
                            </div>

                            <div class="row bloque-rendimiento {{ $detalle->modo_calculo === 'rendimiento' ? '' : 'd-none' }}">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        step="0.01"
                                        name="materiales[{{ $i }}][area_o_volumen]"
                                        class="form-control input-area"
                                        value="{{ $detalle->area_o_volumen }}">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="hidden" class="resultado-calculado" value="{{ $detalle->cantidad }}">
                                </div>
                            </div>
...
let indice = {{ $presupuesto->detalles->count() > 0 ? $presupuesto->detalles->count() : 1 }};
...
function inicializarFila(fila) {
    ...
    // No forzamos cambiarModo() en la carga inicial para no perder los
    // valores precargados del servidor; solo sincronizamos clases visibles.
    let modoActual = fila.querySelector('.radio-modo:checked').value;
    if (modoActual === 'rendimiento') {
        inputArea.disabled = false;
        inputRendimiento.disabled = false;
    } else {
        inputArea.disabled = true;
